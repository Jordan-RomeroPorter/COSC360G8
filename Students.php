	            ...
	            */
	            while($i <= (mysqli_num_rows(mysqli_query($con, "SELECT * FROM students"))))
                {
        	        ...
        	        */
                    ...
                    $dbfblacklist1 = mysqli_query($con,"SELECT blacklist FROM students WHERE rows = $i");
                    $dbfblacklist2 = mysqli_query($con,"SELECT blacklist FROM students WHERE rows = $i");
                    $dbfblacklist3 = mysqli_query($con,"SELECT blacklist FROM students WHERE rows = $i");
                    $dblblacklist1 = mysqli_query($con,"SELECT blacklist FROM students WHERE rows = $i");
                    $dblblacklist2 = mysqli_query($con,"SELECT blacklist FROM students WHERE rows = $i");
                    $dblblacklist3 = mysqli_query($con,"SELECT blacklist FROM students WHERE rows = $i");
